...
const Header: React.FC<DarkTheme> = ({darkTheme, ChangeTheme}) => {
    ...
    return (
        <div>
            <div className={darkTheme ? header.mainBlockDark : header.mainBlock}>
                <div onMouseMove={() => {ChangeHoverBurger(false)}} onMouseLeave={() => {ChangeHoverBurger(true)}}>
                    {hoverBurger
                ...
                <div onMouseMove={() => {ChangeHover(false)}} onMouseLeave={() => {ChangeHover(true)}}>
                    {hover
